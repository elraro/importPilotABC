def create_data_table_completados():
    return "CREATE TABLE IF NOT EXISTS `piloto_barajas`.`completados` (" \
...
def create_data_table_calidad():
    return "CREATE TABLE IF NOT EXISTS `piloto_barajas`.`calidad` (" \
           "`FechaInicio` VARCHAR(19)," \
           "`FechaFin` VARCHAR(19)," \
           "`Hash` VARCHAR(44)," \
           "`Instalacion` VARCHAR(11)," \
